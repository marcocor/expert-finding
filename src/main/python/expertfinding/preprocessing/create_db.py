...
def main():
    ...
    parser.add_argument("-i", "--input", required=True,
                        action="store", help="Input file(s)")
    parser.add_argument("-f", "--input_format", required=True, action="store",
                        help="Format of input file(s)", choices=datasetreader.SUPPORTED_FORMATS)
    parser.add_argument("-c", "--cache_dir", required=True,
                        action="store", help="Cache directory")
    parser.add_argument("-s", "--storage_db", required=True,
                        action="store", help="Storage DB file")
    ...
    parser.add_argument("-l", "--lucene_dir", required=False,
                        action="store", help="Lucene index root directory")
    parser.add_argument("-miny", "--min_year", required=False, action="store", type=int,
                        default=MIN_YEAR, help="Minimum year to consider in document collection")
    parser.add_argument("-maxy", "--max_year", required=False, action="store", type=int,
                        default=MAX_YEAR, help="Maximum year to consider in document collection")
